                    ...
                    FAuth.createUserWithEmailAndPassword(emailid,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(ChefRegistration.this, "User Creted", Toast.LENGTH_SHORT).show();
                                ...
                                documentReference.set(hashMap1).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(ChefRegistration.this, "Successfully Registered", Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(getApplicationContext(),ChefNavigation.class));
                                    }
                                });
                            }
                            else{
                                Toast.makeText(ChefRegistration.this, "Error!", Toast.LENGTH_SHORT).show();
                                mDialog.dismiss();
                            }
