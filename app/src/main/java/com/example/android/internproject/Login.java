    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    mDialog.dismiss();
                                        ...
                                        Intent Z = new Intent(Login.this,ChefNavigation.class);
                                        startActivity(Z);
                                        finish();
            ...
            signup.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Login.this,ChefRegistration.class));
                    finish();
                }
            });
...
//                    finish();
            ...
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Login.this,Chefloginphone.class));
                    finish();
                }
            });
        }catch (Exception e){
